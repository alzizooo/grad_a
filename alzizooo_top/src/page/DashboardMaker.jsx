...
import ExamResultDetails from "./ExamResultDetails.tsx";
import AI from "./AI.tsx";
import QB from "./QB.tsx";
import Grade from './Grade.tsx';
import Batats from './Batats.tsx';
import Behavior from './Behavior.tsx';
import ReviewOption from './ReviewOption.tsx';
import SelectedQuestionQB from './SelectedQuestionQB.tsx';
import QBOpen from './QBOpen.tsx';
import Courses from './Courses.tsx';
import ExamRestriction from './ExamRestriction.tsx';
import DateTime from './DateTime.tsx';
import ShowExam from './ShowExam.tsx';



// import AvgScore from "./AvgScore.tsx";
  ...
  return (
    <div className="relative w-40" ref={dropdownRef}>
      <button
        ...
        className="w-full px-3 py-2 text-left bg-white border border-gray-200 rounded-md flex items-center justify-between text-sm hover:bg-gray-50 transition-colors"
      >
          ...
          {options.map((option) => (
            <button
              ...
              className={`w-full px-3 py-2 text-left text-sm hover:bg-gray-50 transition-colors
                ${selected === option.label ? 'bg-gray-50 text-gray-900' : 'text-gray-700'}`}
            >
              {option.label}
            </button>
          ))}
...
const ResponsiveDashboardM = () => {
  ...
  const menuItems = [
    { name: "Dashboard", icon: LayoutGrid, path: "/maker", tooltip: "View your dashboard" },
    { name: "Exams", icon: FileText, path: "/maker/exams", tooltip: "View upcoming exams" },
    { name: "Grades", icon: ClipboardList, path: "/maker/grades", tooltip: "Check your grades" },
    { name: "Settings", icon: Settings, path: "/maker/settings", tooltip: "Manage your settings" },
    { name: "Support", icon: HelpCircle, path: "/maker/support", tooltip: "Get help" },
  ];
        ...
        <div className="p-4 h-full flex flex-col">
          <div className="flex items-center justify-between mb-8">
            <div className="flex items-center gap-2 hover:opacity-80 transition-opacity cursor-pointer">
              <img
                src="/src/assets/images/WhatsApp Image 2024-12-28 at 11.44.48 AM.jpeg"
                alt="Smartex Logo"
      ...
      <div className="flex-1 flex flex-col">
        ...
        <header className="bg-white py-4 px-6 flex items-center justify-between shadow-sm">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-4">
              <h1 className="text-2xl font-semibold">Welcome Back Taker 👋</h1>
        ...
        <Routes>
          ...
          <Route path="/grading" element={<Grade/>} />
          <Route path="/Batats" element={<Batats/>} />
          <Route path="/ReviewOption" element={<ReviewOption/>} />
          ...
          <Route path="/SelectedQuestionQB" element={<SelectedQuestionQB/>} />
          <Route path="/QBOpen" element={<QBOpen/>} />
          <Route path="/Courses" element={<Courses/>} />
          <Route path="/ExamRestriction" element={<ExamRestriction/>} />
          <Route path="/DateTime" element={<DateTime/>} />
          <Route path="/ShowExam" element={<ShowExam/>} />
...
export default ResponsiveDashboardM;